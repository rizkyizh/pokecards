...
import { createItemTemplate,bgColorCardConverter, createModalPokemonStatsDetail } from "../templates/template-creator";
...
_afterPopulatePokemonList(containerEl){
  ...
  containerEl.addEventListener('click', (event) => {
    if (event.target.id === 'pokeCard') {
      ...
      .innerHTML = createModalPokemonStatsDetail({title: pokeCardId})
